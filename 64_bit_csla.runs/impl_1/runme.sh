...
HD_PWD='C:/Users/MANGALPALLY/64_bit_csla/64_bit_csla.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log csla_64_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source csla_64_bit.tcl -notrace
